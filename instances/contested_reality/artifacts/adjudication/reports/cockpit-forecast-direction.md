...
generated 2026-09-01T05:39:58Z  |  `adjudication_engine.cockpit_s7l`/`render_cockpit_s7l`  |  recorded `metric://` series + recorded `direction` (default `higher-is-better`) + recorded threshold -> Q3 forecast attention + Q8 do-nothing expected-impact, BOTH directions  |  SPEC v0.22, 49 $defs, URI cap
