...
generated 2026-09-01T05:45:51Z  |  `capacity_rerank.capacity_rerank` (new, additive) + engine `cockpit_s7l` advisory  |  NO engine change (hash a60f8f7…); SPEC v0.22, 49 $defs, URI cap, no new noun.
