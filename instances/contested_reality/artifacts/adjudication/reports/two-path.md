...
generated 2026-09-01T05:31:06Z  |  `run_two_path_demo._surface` + engine `cockpit_s7l` advisory + `capacity_rerank.capacity_rerank`  |  NO engine change (hash a60f8f7…) and `capacity_rerank.py` (sha256 f7c6a185…) BYTE-IDENTICAL; SPEC v0.22, 49 $defs, no new noun.
