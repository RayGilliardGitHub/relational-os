...
generated 2026-09-01T06:22:47Z  |  `adjudication_engine.cockpit_s7l`/`render_cockpit_s7l`  |  recorded `metric://` series + recorded last-point `variance` (magnitude σ) -> Q8/trade-off do-nothing priced as a projected BAND (worst ± σ) where the data exists; a no-variance series keeps the Sprint-22 single-point output byte-identical  |  SPEC v0.22, 49 $defs, URI cap
