# Northglen Bank — brand

> Company-branding component (Sprint 7, v1 self-contained). Carried as additive `brand` fields on the company `org://` actor org://fin/northglen (URI cap held; not a new noun).
...
**Mission.** Commit and settle funding tranches reliably and on time so corporate clients can run their working-capital plans to a schedule they can trust.
