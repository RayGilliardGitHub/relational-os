#!/usr/bin/env python3
"""Re-run Sprint-0's conformance validator over Sprint-0, -1, -2, -3, -4, and -5 fixtures.

Reuses the Sprint-0 validator verbatim, repointing its FIXTURES root at each generation's
fixtures in turn — non-regression proven by the exact same gate across all six. Exit 0.

Usage:  <sprint0-venv>/bin/python run_s5_conformance.py
"""
import sys
...
ROOTS = [
    ...
    ("sprint-4", HERE.parents[1] / "sprint-4/artifacts/fixtures"),
    ("sprint-5", HERE / "fixtures"),
]
