#!/usr/bin/env python3
"""Re-run Sprint-0's conformance validator over Sprint-0, -1, -2, -3, and -4 fixtures.

Reuses the Sprint-0 validator verbatim (same code, same schema), repointing its FIXTURES
root at each generation's fixtures in turn, so non-regression is proven by the exact same
gate across all five. Exit 0 = ALL PASS.

Usage:  python3 run_s4_conformance.py
"""
import sys
