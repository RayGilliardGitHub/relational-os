...
class S3Service:
    ...
    def risk(action: str) -> tuple[bool, bool]:
        ...
        REVERSIBLE = {
            ...
            # Sprint-4 (S4) scenario actions — additive, keeps the §6 risk map honest
            "issue_paystub_and_disburse": (False, True),   # payroll micro-action, reversible
            "prepare_installation": (False, True),          # charity install prep, reversible
            "dispatch_solar_crew": (False, True),           # charity despatch, reversible
        }
        ...
        IRREVERSIBLE = {
            ...
            # Sprint-4: a charitable grant, once sent, is not retrievable; cost unknowable
            "release_charitable_grant": (True, False),
        }
